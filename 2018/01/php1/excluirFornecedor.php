        ...
        <div class="row">
            <div class="col s12">
                <form method="post">
                    ...
                    <div class="row">
                        <div class="col s6 input-field">
                            <input type="text" name="cnpj" id="cnpj" value = "<?php echo $cnpj; ?>" readonly>
                            <label for="cnpj">Cnpj</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col input-field s6">
                            <input type="text" name="razao_social" id="razao_social" value="<?php echo $razao_social; ?>" readonly>
                            <label for="razao_social">Razão Social</label>
                        </div>
                    </div>
                    <div class="row">
                      <div class="col s6 center">
                      <button class="btn waves-effect" name="submit" type="submit"><i class="material-icons right">delete</i>Excluir</button>
                      </div>
                    </div>
                    ...
                    <?php 
                        if(isset($_POST['submit'])){
                            $con = getConnection();
                            $sql = "DELETE FROM fornecedor WHERE fornecedor.id_fornecedor  = ".$id;
