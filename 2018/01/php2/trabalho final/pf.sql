...
CREATE TABLE IF NOT EXISTS `mydb`.`usuario` (
  ...
  `administrador` TINYINT NULL COMMENT 'Campo do tipo Boolean, para salvar se o usuário cadastrado é ou não administrador do sistema. \n\n\n',
