                ...
                <form method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" class="form-control" id="nome" name="nome" placeholder="Informe o nome do Produto">
                        </div>

                        <div class="for-group col-md-4">
                            <label class="codigo">Código</label>
                            <input class="form-control" type="text" id="codigo" name="codigo" placeholder="***.***.**">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                        <label class="estoque">Estoque</label>
                        <input class="form-control" type="number" id="estoque" name="estoque" placeholder="">
                        </div>
                   
                        <div class="form-group col-md-4">
                            <label class="preco_venda">Preço de Venda</label>
                            <input pattern="[0.9]*" step="any" class="form-control" type="number" id="preco_venda" name="preco_venda" placeholder="$$$">  
                        </div>
                        <div class="for-group col-md-4">
                            <label class="preco_compra">Preço de Compra</label>
                            <input pattern="[0-9]+$" step="any" class="form-control" type="number" id="preco_compra" name="preco_compra" placeholder="$$$">
                        </div>
                    </div>    
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label class="perecivel">Perecível</label>
                                <input class="form-control" type="checkbox" id="perecivel" name="perecivel" placeholder="Sim ou Não">  
                            </div>
                            <div class="form-group col md-4">
                                <label class="data">Data De Validade</label>
                                <input class="form-control" type="date" id="data" name="data" placeholder="">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="ativo">Ativo</label>
                                <input class="form-control" type="text" id="ativo" name="ativo" placeholder="Sim ou Não">
                            </div>
                        </div>
                        
                            <div class="form-group">
                                <label class="descricao">Descrição</label>
                                <input class="form-control" type="text" id="descricao" name="descricao" placeholder="informe a descrição do produto">             
                            </div>
                        <p class="text-center">  
