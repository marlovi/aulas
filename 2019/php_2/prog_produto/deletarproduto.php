  ...
  <body>
    <div class="container">
        <div class="row">
            <div class="col">
                <form method="POST">
                    <center><h1 class = "my-4 font-italic" style="color: #4682B4;">Excluir de Produto</h1></center>
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            <label for="nome">Nome</label>
                            <input  value="<?php  echo $produto->getNome(); ?>" type="text" class="form-control" id="nome" name="nome" placeholder="Informe o nome do Produto" readonly>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <p class="text-center">  
                            <button type="submit" name="enviar" class="btn btn-outline-primary">Excluir Produto</button>
                        </p>
                    </div>
