...
--
-- Host: localhost:3306
-- Tempo de geração: 22/04/2019 às 18:13
...
INSERT INTO `endereco` (`id_endereco`, `cep`, `rua`, `bairro`, `num`, `complemento`, `cidade_id_cidade`) VALUES
(5, 8, '84545', 'skld', 3, '54545', 102),
(6, 75858, 'rua blbkaj', 'alksdf', 4, 'fdd', 5432);
...
INSERT INTO `produto` (`id_produto`, `nome`, `valor`, `codigo_barras`, `descricao`, `data_validade`, `perecivel`) VALUES
(1, 'atualizar', '87.00', 'asdjlka', 'lsakjç', '2018-03-19', 0),
(4, 'teste', '3435.00', '2341', 'testesdlkjal', '2026-06-21', 0),
(7, 'test', '34.00', 'sdfsda', 'lksdfj', '2032-06-21', 1),
(8, 'banana', '342.00', 'asdfjklç', 'Fruto e etc', '2019-05-22', 1),
(9, 'adjk', '3214.00', 'saj', 'dlskak', '4322-03-31', 0),
(10, 'banana da eduarda', '3.00', 'kjsçlfaj', 'banana delicia ', '2021-05-21', 0),
(11, 'asdfa', '8585.56', 'asdfa', 'sdfafasdfas', '2022-06-23', 1);
...
INSERT INTO `usuario` (`id_usuario`, `nome`, `email`, `cpf`, `rg`, `senha`) VALUES
(5, 'teste', 'teste@email', 546, 65465, 'asdf'),
(6, 'eduarda', 'edu@hotmail.com', 4234524, 435234, 'edu');
...
CREATE TABLE `usuario_endereco` (
  `id_usuario_endereco` int(11) NOT NULL,
  `usuario_id_usuario` int(11) NOT NULL,
  `endereco_id_endereco` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Fazendo dump de dados para tabela `usuario_endereco`
--

INSERT INTO `usuario_endereco` (`id_usuario_endereco`, `usuario_id_usuario`, `endereco_id_endereco`) VALUES
(5, 5, 5),
(6, 6, 6);
...
--
-- Estrutura para tabela `usuario_produto`
--

CREATE TABLE `usuario_produto` (
  `id_usuario_produto` int(11) NOT NULL,
...
--
-- Estrutura para tabela `usuario_telefone`
--

CREATE TABLE `usuario_telefone` (
  `id_usuario_telefone` int(11) NOT NULL,
  `telefone_id_telefone` int(11) NOT NULL,
  `usuario_id_usuario` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Fazendo dump de dados para tabela `usuario_telefone`
--

INSERT INTO `usuario_telefone` (`id_usuario_telefone`, `telefone_id_telefone`, `usuario_id_usuario`) VALUES
(5, 5, 5),
(6, 6, 6);
...
ALTER TABLE `endereco`
  ...
  ADD KEY `fk_endereco_cidade1_idx` (`cidade_id_cidade`);
...
ALTER TABLE `usuario_endereco`
  ADD PRIMARY KEY (`id_usuario_endereco`),
  ADD KEY `fk_endereco_has_cliente_cliente1_idx` (`usuario_id_usuario`),
  ADD KEY `fk_usuario_endereco_endereco1_idx` (`endereco_id_endereco`);

--
-- Índices de tabela `usuario_produto`
--
ALTER TABLE `usuario_produto`
  ADD PRIMARY KEY (`id_usuario_produto`),
  ADD KEY `fk_produto_has_cliente_cliente1_idx` (`usuario_id_usuario`),
  ADD KEY `fk_produto_has_cliente_produto_idx` (`produto_id_produto`);

--
-- Índices de tabela `usuario_telefone`
--
ALTER TABLE `usuario_telefone`
  ADD PRIMARY KEY (`id_usuario_telefone`),
  ADD KEY `fk_usuario_has_telefone_telefone1_idx` (`telefone_id_telefone`),
  ADD KEY `fk_usuario_has_telefone_usuario_idx` (`usuario_id_usuario`);
...
--
ALTER TABLE `usuario_endereco`
  MODIFY `id_usuario_endereco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de tabela `usuario_produto`
--
ALTER TABLE `usuario_produto`
  MODIFY `id_usuario_produto` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `usuario_telefone`
--
ALTER TABLE `usuario_telefone`
  MODIFY `id_usuario_telefone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `usuario_endereco`
  ADD CONSTRAINT `fk_endereco_has_cliente_cliente1` FOREIGN KEY (`usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_usuario_endereco_endereco1` FOREIGN KEY (`endereco_id_endereco`) REFERENCES `endereco` (`id_endereco`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `usuario_produto`
--
ALTER TABLE `usuario_produto`
  ADD CONSTRAINT `fk_produto_has_cliente_cliente1` FOREIGN KEY (`usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_produto_has_cliente_produto` FOREIGN KEY (`produto_id_produto`) REFERENCES `produto` (`id_produto`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `usuario_telefone`
--
ALTER TABLE `usuario_telefone`
  ADD CONSTRAINT `fk_usuario_has_telefone_telefone1` FOREIGN KEY (`telefone_id_telefone`) REFERENCES `telefone` (`id_telefone`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_usuario_has_telefone_usuario1` FOREIGN KEY (`usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
